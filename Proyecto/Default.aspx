...
<html lang="en">
  <head runat="server">
    ...
    <title>Sistema de Votacion Online</title>
  ...
  <body>
    ...
    <div class="navmenu navmenu-default navmenu-fixed-left offcanvas"> <!--- Off Canvas Side Menu -->
        ...
        <ul class="nav navmenu-nav"> <!--- Menu -->
            ...
            <li><a href="#contact1" class="page-scroll">INICIA SESION</a></li>
            <li><a href="#contact" class="page-scroll">REGISTRATE</a></li> 
            <!---<li><a href="#works" class="page-scroll">Estadisticas</a></li>
            <li><a href="#about-us" class="page-scroll">Sobre Nosotros</a></li>
            <li><a href="#contact" class="page-scroll">Contactenos</a></li>
        </ul><!--- End Menu -->
    ...
    <div id="home">
        <div class="container text-center">
            ...
            <div class="content">
                <h4>Informacion confiable y consistente a tu alcance</h4>
                <hr>
            ...
            <a href="#contact1" class="down-btn page-scroll">
        ...
        <!--<div class="container">
            <div class="row text-center">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <p>Bienvenido a tu portal web, aca podras realizar tu voto y ver en tiempo real quien lleva la delantera ANIMATE Y REGISTRATE¡¡</p>
    ...
    <!-- Contact Section -->
        ...
        <div class="container">
            <div class="section-title text-center">
                <h2>User<asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
                    <br>
                    Pass<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                    <br>
                    <asp:Button ID="Button3" runat="server" Text="Enviar" OnClick="Button3_Click1" />
                </h2>
                <hr>
            </div>
            <div class="space"></div>
...
<%--            <div class="row">
                <div class="col-md-3">
                    <address>
                        <strong>LLENE SUS DATOS</strong><br>
                        <br>
                        <br>
                        <br>
                        <br>
...
<%--                <div class="col-md-9">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                        ...
                        <textarea class="form-control" rows="4" placeholder="Message"></textarea>
                        <div class="text-right">
                            <%--<asp:Button ID="Button2" runat="server" Text="Enviar"  Width="40%" class="btn send-btn" OnClick="Button2_Click"/>--%>
                        </div>
                    </form>
               </div>
            </div>
    ...
    <nav id="footer">
        <div class="container">
            ...
            <div class="pull-right"> 
                <a href="#home" class="page-scroll">Volver al inicio <span class="fa fa-angle-up"></span></a>
            </div>
        </div>
    </nav>
    ...
    <script>
      $(function(){
          $("#head-title").typed({
            strings: ["Sistema de votacion online", "24/7 disponible para su organizacion" ,"Agradable y facil de usar"],
            typeSpeed: 100,
            loop: true,
            startDelay: 100
          });
